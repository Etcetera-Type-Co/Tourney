...
echo "Generating VFs"
fontmake -g sources/Tourney.glyphs -o variable --output-path ./fonts/variable/Tourney[ital,wdth,wght].ttf
...
fontmake -g sources/Tourney.glyphs -i -o ttf --output-dir ./fonts/static/ttf/

fontmake -g sources/Tourney.glyphs -i -o otf --output-dir ./fonts/static/otf/
