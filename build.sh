...
fontmake -g Tourney.glyphs -i -o ttf --output-dir ../fonts/static/ttf/

mkdir -p ../fonts/static/otf
fontmake -g Tourney.glyphs -i -o otf --output-dir ../fonts/static/otf/

#echo "Generating VFs"
#fontmake -g Tourney.glyphs -o variable --output-path ../fonts/Tourney[slnt,wght].ttf
...
woff2_compress TourneyVariable.ttf
...
vf=../fonts/variable/TourneyVariable.ttf
